...
%%%%%%%%% TITLE
\title{Persistance of Vision Display}
...
For this reason, KU Leuven Campus De Nayer wanted persistance of vision display made. 

Persistance of vision (POV) is an optical phenomenon which makes it that humans perceive an image for longer than the existance of the actual image.
Thanks to this phenomenon, a single line of LEDs that turns around at a high enough speed can be used as a display.

This project aims to create a POV display for the university, with high image quality and a user friendly interface, by developing the both software and hardware of it.
...
There were 2 different types of POV displays we found while looking up existing projects, with the LEDs either on the rotating plane, which creates a circle, or perpendicular, creating a cylinder~\cite{Hackaday1}. 
...
\subsubsection{Design of the PCB}
\subsubsection{Electronics}
\subsection{Software}
\subsubsection{getting the images ready}
\subsubsection{controlling the LEDs }
\subsubsection{Communicating with the display}
